...
public class StudentController {
    ...
    public String addStudent(HttpServletRequest request, HttpServletResponse response){
        ...
        student.setStudent_id(studentID).setName(name).setAge(age).setSex(sex).setBirthday(birthday);
        studentService.addStudent(student);
        return "redirect:listStudent";
    }

    @RequestMapping("/listStudent")
    public String listStudent(HttpServletRequest request , HttpServletResponse response,Model model){
        ...
        int total = studentService.getTotle();
        page.setTotal(total);
