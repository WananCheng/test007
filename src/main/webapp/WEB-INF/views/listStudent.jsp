    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
        ...
        <c:forEach items="${students}" var="s" varStatus="status">
            <tr>
                ...
                <td><a href="/index/editStudent?id=${s.id}" ><span class="glyphicon glyphicon-edit"></span></a> </td>
                <td><a href="/index/deleteStudent?id=${s.id}" onclick="del()"><span class ="glyphicon glyphicon-trash "></span></a></td>
            </tr>
        </c:forEach>
    </table>
</div>
...
<div class="addDIV">
    ...
    <div class="panel-body">
        <form  id="addForm" method="post" action="/index/addStudent" role="form">
